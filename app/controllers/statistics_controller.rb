class StatisticsController < ApplicationController
    ...
    def num_publications_by_user_and_type
        ...
        if user_id.to_i > num_users
            render json:{
                num_publications_by_user_and_type: "El usuario solicitado no se encuentra registrado en nuestra base de datos"
            }, status: :ok
        else
            data = Hash.new
    ...
    def num_publications_by_rg_and_type
        ...
        if rg_id.to_i > num_research_groups
            render json:{
                num_publications_by_rg_and_type: "El grupo solicitado no se encuentra registrado en nuestra base de datos"
            }, status: :ok
        else
            data = Hash.new
    ...
    def overall_num_pubs_by_users_in_rg
        ...
        if rg_id.to_i > num_research_groups
            render json:{
                overall_num_pubs_by_users_in_rg: "El grupo solicitado no se encuentra registrado en nuestra base de datos"
            }, status: :ok
        else
            data = Hash.new
            data["research_group_name"] = ResearchGroup.find_by_id(rg_id).name
